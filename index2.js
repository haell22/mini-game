...
const locations = [
    ...
    },
    {
        ...
        text: "The monster screams \"Arg!\" as it dies. You gained experience points and earned gold."
    },
    {
        name: "lose",
    ...
    },
    {
        ...
        text: "You found a secret game! Pick a number above. Ten numbers will be randomly chosen between 0 and 10. If the number you choose matches on of the random numbers, you win!"
    }
];
// initialize buttons
...
function pick(guess) {
    ...
    if (numbers.indexOf(guess) !== -1){
        ...
        if (health <= 0) {
            ...
            text.innerText += "Oh no! You lost 10 health!"
        }
